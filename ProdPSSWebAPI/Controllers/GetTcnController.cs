...
namespace ProdPSSWebAPI.Controllers
{
    ...
    public class GetTcnController : ApiController
    {
        [HttpPost]
        public string getFileFromTCN()
        {
